...
public class IncrementalStandaloneBuilderTest {
  ...
  @Inject
  private LanguageAccessFactory languageAcessFactory;
  ...
  protected IndexState build(final BuildRequest buildRequest) {
    ...
    final Map<String, LanguageAccess> languages = this.languageAcessFactory.createLanguageAccess(Collections.<ILanguageConfiguration>unmodifiableList(CollectionLiterals.<ILanguageConfiguration>newArrayList(_testLanguageConfiguration)), _classLoader);
