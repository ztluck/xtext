...
protected class CrossRefNameTest_RefAssignment_3_0_1 extends AssignmentToken  {
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::CrossReferenceImpl
			IEObjectConsumer param = createEObjectConsumer((EObject)value);
			if(param.isInstanceOf(grammarAccess.getCrossRefNameTestAccess().getRefCrossRefNamedCrossReference_3_0_1_0().getType().getClassifier()) && (!(crossRefSerializer instanceof org.eclipse.xtext.parsetree.reconstr.impl.CrossReferenceSerializer)) || ((org.eclipse.xtext.parsetree.reconstr.impl.CrossReferenceSerializer)crossRefSerializer).isValid(obj.getEObject(), grammarAccess.getCrossRefNameTestAccess().getRefCrossRefNamedCrossReference_3_0_1_0(), (EObject)value , null)) {
				type = AssignmentType.CROSS_REFERENCE;
...
protected class CrossRefNameTest_RefAssignment_3_1_1 extends AssignmentToken  {
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::CrossReferenceImpl
			IEObjectConsumer param = createEObjectConsumer((EObject)value);
			if(param.isInstanceOf(grammarAccess.getCrossRefNameTestAccess().getRefCrossRefNamedCrossReference_3_1_1_0().getType().getClassifier()) && (!(crossRefSerializer instanceof org.eclipse.xtext.parsetree.reconstr.impl.CrossReferenceSerializer)) || ((org.eclipse.xtext.parsetree.reconstr.impl.CrossReferenceSerializer)crossRefSerializer).isValid(obj.getEObject(), grammarAccess.getCrossRefNameTestAccess().getRefCrossRefNamedCrossReference_3_1_1_0(), (EObject)value , null)) {
				type = AssignmentType.CROSS_REFERENCE;
