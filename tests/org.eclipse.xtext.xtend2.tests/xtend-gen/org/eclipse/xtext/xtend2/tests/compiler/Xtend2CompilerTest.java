...
public class Xtend2CompilerTest extends AbstractXtend2TestCase {
  ...
  public void testFreshNames() throws Exception {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("package foo");
    _builder.newLine();
    _builder.append("class Bar {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def boolean doStuff(java.lang.Class _class) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("\"foo\".^class == _class");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public boolean doStuff(final Class _class) {");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("Class<? extends Object> _class_1 = \"foo\".getClass();");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("boolean _operator_equals = ObjectExtensions.operator_equals(_class_1, _class);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return _operator_equals;");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testFreshNames_2() throws Exception {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("package foo");
    _builder.newLine();
    _builder.append("class Bar {");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("val x = \"foo\".^class");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("val x2 = [| \"foo\".^class ]");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("Class<? extends Object> _class = \"foo\".getClass();");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Class<? extends Object> x = _class;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Function0<Class<? extends Object>> _function = new Function0<Class<? extends Object>>() {");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("public Class<? extends Object> apply() {");
    _builder_1.newLine();
    _builder_1.append("            ");
    _builder_1.append("Class<? extends Object> _class = \"foo\".getClass();");
    _builder_1.newLine();
    _builder_1.append("            ");
    _builder_1.append("return _class;");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Function0<Class<? extends Object>> x2 = _function;");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testFreshNames_3() throws Exception {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("package foo");
    _builder.newLine();
    _builder.append("class Bar {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def void doStuff(String _class) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("val x = \"foo\".^class");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public void doStuff(final String _class) {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("Class<? extends Object> _class_1 = \"foo\".getClass();");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Class<? extends Object> x = _class_1;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Function0<Class<? extends Object>> _function = new Function0<Class<? extends Object>>() {");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("            ");
    _builder_1.append("return _class_1;");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("}");
    _builder_1.newLine();
